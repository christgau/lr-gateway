// You may adopt your own practices by all means, but in general it is best
 ...
 main   (int argc, char *argv[])
 {
     ...
     //
     oris_automationParser_expr_return     langAST;
     ...
     // the tree parser: c.f. oris_automationDumpDecl.g3t This is the ctx (CTX macro) pointer for your
        // tree parser.
     //
     poris_automationParser          treePsr;
    ...
    else
    {
     ...
     //
     lxr        = oris_automationLexerNew(input);      // CLexerNew is generated by ANTLR
     ...
     //
     psr        = oris_automationParserNew(tstream);  // CParserNew is generated by ANTLR3
...
/* tree parser stuff, currently not used
 *
